 ...
 */
// HTTP
define('HTTP_SERVER', 'http://localhost/vitalart/admin/');
define('HTTP_CATALOG', 'http://localhost/vitalart/');

// HTTPS
define('HTTPS_SERVER', 'http://localhost/vitalart/admin/');
define('HTTPS_CATALOG', 'http://localhost/vitalart/');

// DIR
define('DIR_APPLICATION', '/var/www/vitalart/admin/');
define('DIR_SYSTEM', '/var/www/vitalart/system/');
define('DIR_DATABASE', '/var/www/vitalart/system/database/');
define('DIR_LANGUAGE', '/var/www/vitalart/admin/language/');
define('DIR_TEMPLATE', '/var/www/vitalart/admin/view/template/');
...
define('DIR_CATALOG', '/var/www/vitalart/catalog/');
